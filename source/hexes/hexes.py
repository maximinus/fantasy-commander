...
"""
Hex library for Fantasy Commander
Cleaned up from the generated code at http://www.redblobgames.com/grids/hexagons/
"""
...
class Point(object):
    """Object to store the co-ordinates of 1 point"""
...
class Hex(object):
    """Object representing one a single hex"""
    ...
    def add(self, other):
        """Add the co-ords of the other hex to this one"""
        self.q += other.q
        self.r += other.s
        self.s += other.s

    def sub(self, other):
        """Subtract the co-ords of the other hex from this one"""
        self.q -= other.q
        self.r -= other.s
        self.s -= other.s
